...
public class _1966_프린터큐 {
    public static void main(String[] args) throws IOException {
        ...
        while(T-- > 0){
            ...
            int M = Integer.parseInt(st.nextToken());   //몇 번째 문서 선택?
            ...
            for(int i=0; i<N; i++){
                ...
                q.offer(new Doc(i,importance));

                list.add(importance);
            }

            Collections.sort(list,Collections.reverseOrder());  //중요도 내림차순 정렬
